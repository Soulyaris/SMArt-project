<header>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        <a class="navbar-brand" href="{{ route('welcome') }}"><img src="/images/smart.png" width="90px"></a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('users.show', Auth::user()->id) }}">Profile page</a>
                            <a class="dropdown-item" href="{{ route('users.edit', Auth::user()->id) }}">Manage profile</a>
